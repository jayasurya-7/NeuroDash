...
$(document).ready(function() {
    ...
    function updateChartsWithRange(startIndex) {
        // Adjust startIndex to show the last 20 data points initially
        startIndex = Math.max(0, dataCache.length - daysToShow);
        ...
        console.log("Data Range:", dataRange); // Debug: Check the sliced data
